  ...
  return (
    <footer className="bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center mb-8 md:flex-row md:justify-between md:items-center">
        ...
        {/* Bilgi listeleri */}
        <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-5 md:text-left">
          <div>
          ...
          <div>
            ...
            />
            <button className="bg-blue-500 text-white px-4 py-2 rounded w-full">Subscribe</button>
