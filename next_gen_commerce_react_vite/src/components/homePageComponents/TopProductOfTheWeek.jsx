    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="relative" style={{ width: '612px', height: '572px' }}>
          ...
          <div className="absolute  bg-opacity-75 text-center flex flex-col items-center justify-center"
               style={{ width: '420px', height: '238px', top: '334px', left: '-1px', padding: '140px 155.5px 42px 66px', gap: '20px' }}>
